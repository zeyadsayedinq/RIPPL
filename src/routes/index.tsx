...
const SCENES = [
  {
    url: BASE + "hf_20260702_081127_0992a171-d3c6-4978-8213-0ec5df8b6d63.mp4",
    label: "Command",
  },
  {
    url: BASE + "hf_20260702_092026_dd05b805-ea0f-40b2-8c52-332b88502592.mp4",
    label: "Network",
  },
  {
    url: BASE + "hf_20260702_081042_df7202bf-bd80-4b2b-bbc6-1f09ba2870e9.mp4",
    label: "Studio",
  },
  {
    url: BASE + "hf_20260702_080959_4cac5234-3573-464e-a5b7-76b94b8a7d61.mp4",
    label: "Night Ops",
  },
];
...
function Universe() {
  ...
  const openInvoices = os.invoices.filter(
    (i) => i.status !== "Paid" && i.status !== "Void",
  ).length;
  const upcomingShows = os.gigs.filter(
  ...
  const stats = [
    ...
    { label: "Shows", value: upcomingShows },
    { label: "Partners", value: os.affiliates.length },
    { label: "Playbooks", value: KNOWLEDGE.length },
  ];
  const modules = [
    {
      to: "/roster",
    ...
    },
    {
      ...
      icon: <Disc3 size={32} strokeWidth={2.5} />,
    ...
    },
    {
      ...
      icon: <FolderLock size={32} strokeWidth={2.5} />,
    ...
    },
    {
      ...
      gradient:
        "linear-gradient(137deg, #06B6D4 0%, #A5F3FC 45%, #FFFFFF 100%)",
      delay: 0.25,
    },
    {
      to: "/techlab",
      ...
      gradient:
        "linear-gradient(137deg, #F72585 0%, #E0AEFF 45%, #4361EE 100%)",
      delay: 0.3,
    },
    {
      to: "/dashboard",
      ...
      gradient:
        "linear-gradient(137deg, #FF9D3C 0%, #FFB1CE 45%, #FF3D77 100%)",
      delay: 0.35,
    },
    {
      to: "/hitlab",
      label: "Hit Lab",
      desc: "Score a track before you back it.",
      icon: <Sparkles size={32} strokeWidth={2.5} />,
      count: os.hitScores.length,
      gradient:
        "linear-gradient(137deg, #A5F3FC 0%, #7DD3FC 45%, #4361EE 100%)",
      delay: 0.4,
    },
    {
      to: "/invoices",
      label: "Invoices",
      desc: "Commissions, quotes & getting paid.",
      icon: <Receipt size={32} strokeWidth={2.5} />,
      count: os.invoices.length + os.commissions.length,
      gradient:
        "linear-gradient(137deg, #FFB1CE 0%, #E0AEFF 45%, #4361EE 100%)",
      delay: 0.45,
    },
    {
      to: "/live",
      label: "Live",
      desc: "Gigs, tickets & break-even.",
      icon: <Ticket size={32} strokeWidth={2.5} />,
      count: os.gigs.length,
      gradient:
        "linear-gradient(137deg, #06B6D4 0%, #7DD3FC 45%, #F72585 100%)",
      delay: 0.5,
    },
    {
      to: "/affiliates",
      label: "Affiliates",
      desc: "Referral partners & payouts.",
      icon: <Share2 size={32} strokeWidth={2.5} />,
      count: os.affiliates.length,
      gradient:
        "linear-gradient(137deg, #FF3D77 0%, #FF9D3C 45%, #FFFFFF 100%)",
      delay: 0.55,
    },
    {
      to: "/knowledge",
      label: "Knowledge",
      desc: "The playbooks behind the numbers.",
      icon: <BookOpen size={32} strokeWidth={2.5} />,
      count: KNOWLEDGE.length,
      gradient:
        "linear-gradient(137deg, #FFFFFF 0%, #E0AEFF 45%, #A5F3FC 100%)",
      delay: 0.6,
    },
  ];
        ...
        <div className="mx-auto w-[min(100%-48px,1820px)] pb-8 pt-10">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-[1.25fr_repeat(3,0.42fr)]">
            <h2
              ...
              style={{ fontSize: "clamp(28px,3.2vw,54px)", fontWeight: 300 }}
            >
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2 text-[10px] text-white/50">
            <span>
              © 2026 RIPPL. All rights reserved. Built by Zeyad Sayedin.
            </span>
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 mx-auto flex max-w-6xl flex-col px-6">
          ...
          <div className="flex flex-1 flex-col justify-center pb-16">
            ...
            >
              Not a dashboard — a command center for everything I build. A&R and
              artist management, music distribution, 360° marketing, and the AI
              tools I ship. Every artist I scout, every record I drop, every
              deal I close, every contract I sign — it all lives here. One brain
