...
import { S as Eye, c as Search, h as Heart, i as TrendingUp, m as Instagram, n as X, r as Users, u as Music2 } from "../_libs/lucide-react.mjs";
import { n as MagneticButton, o as creators, r as SpotlightCard, t as AppShell, u as useRole } from "./mock-data-B-aB0cXw.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/creators-yzG6iTIF.js
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
					...
					children: ["Creator Roster · ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [filtered.length, " creators matched · 97 total in pipeline"]
				})
			]
		}),
...
function CreatorsList({ filtered, selected, onSelectChange }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "hidden lg:grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_auto] items-center gap-4 px-5 py-2 text-[10px] uppercase tracking-[0.2em] text-muted-foreground",
			children: [
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "col-span-2 lg:col-span-1 flex items-center gap-3 min-w-0",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "font-mono text-sm",
					children: canSeePrice ? `$${c.price.toLocaleString()}` : "•••••"
				}),
			...
			children: [
				...
				canSeePrice && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: ["$", creator.price.toLocaleString()]
